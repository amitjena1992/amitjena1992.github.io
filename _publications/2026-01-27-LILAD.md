...
excerpt: 'LILAD is a new in-context learning framework for system identification that jointly ensures adaptability and Lyapunov stability, even under distribution shifts. Trained across diverse tasks, it produces an adaptive dynamics model and adaptive Lyapunov certificate that rapidly specialize to new systems using only a short trajectory prompt.'
date: 2026-01-27
venue: 'AAAI-26'
