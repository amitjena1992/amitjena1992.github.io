...
excerpt: 'This paper proposes a meta-learning-based adaptive Lyapunov function that efficiently adapts to any test-time instance of a dynamical system with parametric uncertainty. As a result, a single Lyapunov function can be trained and then rapidly fine-tuned at test time to assess the stability of any arbitrary system instance.'
date: 2024-02-26
venue: 'AAAI-24'
